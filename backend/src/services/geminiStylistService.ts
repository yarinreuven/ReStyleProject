...
export function buildGeminiStylistPrompt(
  ...
  return [
    ...
    "Use recentSelectionCount, wearCount and lastWornAt for variety only after suitability and harmony; never choose an unsuitable item merely for variety.",
    "When several suitable cohesive choices exist, strongly prefer items with the lowest recentSelectionCount so consecutive generated looks do not repeat the same wardrobe pieces.",
